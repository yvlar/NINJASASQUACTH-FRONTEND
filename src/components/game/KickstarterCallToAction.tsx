...
export default function KickstarterCallToAction({ game }: { game: GameRow }) {
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-6">
      <div className="flex flex-col gap-3 rounded-lg border-l-4 border-l-eco-green bg-eco-green/10 p-6">
        ...
        <a
          ...
          className="inline-flex w-fit items-center gap-2 rounded-lg bg-dark-green px-4 py-2.5 font-semibold text-cream transition-opacity duration-300 hover:opacity-90 motion-reduce:transition-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-eco-green"
        >
